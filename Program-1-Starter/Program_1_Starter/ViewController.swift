...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        self.lblChangeColor.backgroundColor = self.myColors.hexStringToUIColor(randColor.hexValue)
        ...
        //Assign Random Color name to button
        var color = randColor.colorName
        var prev = self.myColors.fetchRandomColor().colorName
        var next = self.myColors.fetchRandomColor().colorName
        
        if(buttonAnswer == 0){
            btnAnswer1OUTLET.setTitle(color, forState: UIControlState.Normal)
        ...
        if(buttonAnswer == 1){
            ...
            btnAnswer2OUTLET.setTitle(color, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(next, forState: UIControlState.Normal)
            button2Correct = true
        }
        ...
        if(buttonAnswer == 2){
            ...
            btnAnswer2OUTLET.setTitle(prev, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(color, forState: UIControlState.Normal)
            button3Correct = true
        }
